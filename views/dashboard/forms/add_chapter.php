    ...
    <div class="row">
        ...
        <div class="col-10">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="name" value="<?= $story->story_name ?>" disabled>
            ...
            <div class="mb-3 text-center">
                ...
                <button class="btn btn-light mx-3" name="addChapter" type="submit">Thêm truyện</button>
            </div>
        </div>
        <div class="col-1">
